...
module.exports = {
    async getAllUsers(opts) {
        return await this._findByType(opts, undefined);
    },
    ...
    async addUser(opts) {
        return new Promise(async(resolve, reject) => {
            ...
            adOu = parseLocation(adOu);
            // if (manager) {
            //     await this.findUser(manager)
            //         .then((data) => {
            //             manager = data.dn;
            //         })
            //         .catch(err => {
            //             reject({ ok: false, error: "Manager account not found" });
            //         });
            // }
            ...
            this._addObject(`CN=${commonName}`, adOu, userObject)
                .then(res => {
                ...
                .then(data => {
                    ...
                    userObject.dn = `CN=${commonName},${adOu}${baseDN}`;
        ...
        return new Promise(async(resolve, reject) => {
            ...
            this.findUser(userName)
                .then(userObject => {
                    ...
                    let newDN = `CN=${userObject.cn},${adOu}${baseDN}`;
