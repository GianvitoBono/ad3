...
class AD {
    constructor(config) {
        ...
        if (!config.userAttributes) config.userAttributes = ["dn", "userPrincipalName", "sAMAccountName", "mail", "whenCreated", "pwdLastSet", "sn", "givenName", "initials", "cn", "physicalDeliveryOfficeName", "mobile", "company", "title", "department", "pwdLastSet", "whenCreated", "postOfficeBox"];
        if (!config.groupAttibutes) config.groupAttibutes = ["dn", "cn", "description", "distinguishedName", "objectCategory"];
