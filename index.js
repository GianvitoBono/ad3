...
class AD {
  constructor(config) {
    ...
    this.ad = new activedirectory({
      ...
      attributes: {
        user:["dn","userPrincipalName","sAMAccountName","mail","whenCreated","pwdLastSet","sn","givenName","initials","cn","physicalDeliveryOfficeName","mobile","company","title","department","telephoneNumber", "pwdLastSet", "whenCreated", "postOfficeBox"],
